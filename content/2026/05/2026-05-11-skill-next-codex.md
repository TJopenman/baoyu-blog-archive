...
date: 2026-05-11
original_url: https://baoyu.io/blog/2026-05-11/skill-next-codex
---
...
![Codex 的野心，MCP 和 Skill 的下一步](https://s.baoyu.io/imgs/2026-05-11/skill-next-codex/cover.png)

这段时间我在密集使用 Codex App、Cursor 等 Agent 应用，有件事越来越觉得有意思。

![](https://s.baoyu.io/imgs/2026-05-11/skill-next-codex/00-codex.jpeg)
...
![Agent 应用的三栏收敛](https://s.baoyu.io/imgs/2026-05-11/skill-next-codex/01-infographic-three-column-agent.png)
...
![右侧工作区的演进](https://s.baoyu.io/imgs/2026-05-11/skill-next-codex/02-flowchart-right-panel-evolution.png)
...
![Agent 能力拼图：还缺哪一块？](https://s.baoyu.io/imgs/2026-05-11/skill-next-codex/03-framework-capability-gap.png)
...
![Agent 版 App Store](https://s.baoyu.io/imgs/2026-05-11/skill-next-codex/04-framework-agent-app-store.png)
...
![留给中小团队的窗口](https://s.baoyu.io/imgs/2026-05-11/skill-next-codex/05-comparison-small-team-window.png)
