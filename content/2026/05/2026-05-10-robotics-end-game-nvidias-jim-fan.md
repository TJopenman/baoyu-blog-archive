...
date: 2026-05-10
original_url: https://baoyu.io/blog/robotics-end-game-nvidias-jim-fan
---

[See all posts](/translations)

Published on 2026-05-10Translated on 2026-04-30

# 机器人的终局：英伟达 Jim Fan 宣告 VLA 时代结束，WAM 登场

原文：[Robotics' End Game: Nvidia's Jim Fan](https://www.youtube.com/watch?v=3Y8aq_ofEVs)
...
![黄仁勋与 Elon Musk 查看第一台 DGX-1](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/jensen-musk-dgx1.jpg)
...
![DGX-1 签名板截图](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/dgx-1-signature.jpg)
...
![Jim Fan 展示“底层同构”：LLM 训练路径对应机器人训练路径](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/great-parallel-diagram.jpg)
...
![VLA 架构示意：视觉语言模型上接动作头](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/vla-lva-architecture.jpg)
...
![RT-2 论文中的可乐罐与 Taylor Swift 泛化示例](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/rt2-coke-taylor-swift.jpg)

## 从 AI 垃圾视频到 DreamZero

VLA 不是答案，那下一个预训练范式是什么？结果发现是视频模型，它们在内部学会了模拟物理世界的下一个状态。

![Jim Fan 用“AI video slop”引出视频世界模型](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/ai-video-slop.jpg)
...
![DreamZero 执行任务时同步展示世界模型视角](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/dreamzero-world-model-view.jpg)
...
![英伟达首席科学家 Bill Dally 亲自做遥操作采集](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/bill-dally-teleop.jpg)

怎么破局？把机器人的末端执行器直接戴在人手上，直接采集数据，完全绕过机器人本体。

英伟达方案是 **DexUMI**，一种外骨骼装置。用外骨骼数据训练出的机器人策略可以完全自主运行，训练数据里没有任何遥操作数据。

![DexUMI 与遥操作数据采集方式对比](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/dexumi-data-collection.jpg)
...
![EgoScale 预训练数据：21K 小时、10K 场景、43K 物体](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/egoscale-human-video-data.jpg)

最重要的发现是：**灵巧操作的神经缩放定律**。预训练投入的算力小时数与最优验证损失之间，存在一条极其清晰的对数线性关系，R² 达到了惊人的 0.998。

![EgoScale 展示的灵巧操作缩放定律曲线](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/egoscale-scaling-law.jpg)

Jim 把所有数据策略的扩展性放在了一起：遥操作在最不可扩展的角落；第一人称视频如果能转动 FSD（Full Self-Driving，完全自动驾驶）式的数据飞轮，一年内能到 1000 万小时。

![传感化人类数据、数据穿戴设备和遥操作的可扩展性对比](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/sensorized-human-data-chart.jpg)
...
![Dream Dojo 的 action-conditioned 神经仿真画面](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/dreamdojo-neural-simulator.jpg)
...
![物理 API 成就：暗工厂和自动化科学实验室](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/physical-api-achievement.jpg)

至于时间表，他类比 AI 从 AlexNet（2012）到智能体（2026）用了 14 年。再加 14 年，正好是 2040 年。

![Jim Fan 用 2012、2026、2040 类比推演机器人终局](https://s.baoyu.io/imgs/2026-05-10/robotics-end-game-nvidias-jim-fan/robotics-2040-roadmap.jpg)
