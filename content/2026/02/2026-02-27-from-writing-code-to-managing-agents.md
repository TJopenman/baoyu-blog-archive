...
date: 2026-02-27
original_url: https://baoyu.io/blog/2026-02-27/from-writing-code-to-managing-agents
---
...
![从写代码到管 Agent：斯坦福首门 AI 软件开发课的讲师说，大多数工程师还没准备好](https://s.baoyu.io/imgs/2026-02-27/from-writing-code-to-managing-agents/cover.png)
...
![](https://s.baoyu.io/imgs/2026-02-27/from-writing-code-to-managing-agents/ytcover.jpg)
...
![初级开发者面临的三重风暴：裁员潮、毕业生暴涨、AI 替代效应](https://s.baoyu.io/imgs/2026-02-27/from-writing-code-to-managing-agents/01-infographic-triple-storm.png)
...
> 真正学会管理多个 Agent，就像通关游戏的最终 Boss。能做到这一点的人，即使在今天也是最顶尖的那 0.1%。
> （”Knowing how to properly handle multiple agents is like the last boss in a game. If you can do that really, really well then you are literally the top top 0.1% of users.”）

![Agent 编排进阶路径：从 1 个逐步增加，而非直接 10 个](https://s.baoyu.io/imgs/2026-02-27/from-writing-code-to-managing-agents/02-flowchart-agent-progression.png)
...
> 如果我走进你的代码库，看到两种不同的做法，我也会问自己：该用哪个？我不知道，两种都在用，我大概率会去问一个同事。
> （“If I were walking to your codebase and saw the two different ways of doing it, I would also ask myself: should I do one or two?”）

**Agent 友好的代码库，其实就是对人也友好的代码库。**

好的工程实践没有变，只是在 Agent 时代变成了硬性要求，而不是”最好这么做”的建议。

![Agent 友好代码库的四大支柱：测试、文档一致、防止错误复合、设计模式统一](https://s.baoyu.io/imgs/2026-02-27/from-writing-code-to-managing-agents/03-framework-agent-friendly-codebase.png)
...
![品味对比：功能性软件完成即止步，卓越软件在最后一公里加速](https://s.baoyu.io/imgs/2026-02-27/from-writing-code-to-managing-agents/04-comparison-taste-last-mile.png)
...
> 年轻人有一种“好的无知无畏”，这对创业者来说是完美的品质。
> （“There's like a good naivety to how young people think, which is perfect for a startup founder.”）

Mihail 认为，即便就业市场确实在变难，但那些最早掌握 AI 原生技能的人，恰恰就是这些初级工程师，最终会成为**最灵活、学习最快的一批人**。

![初级工程师 vs 资深开发者：无知无畏的开放心态 vs 20 年习惯的围墙](https://s.baoyu.io/imgs/2026-02-27/from-writing-code-to-managing-agents/05-comparison-junior-vs-senior.png)
...
> 你造出了最精美的软件，工程过度得离谱，然后你发布了，没人想要它。
