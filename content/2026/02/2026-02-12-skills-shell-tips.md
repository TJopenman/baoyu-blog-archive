...
date: 2026-02-12
original_url: https://baoyu.io/blog/2026-02-12/skills-shell-tips
---
...
![OpenAI 智能体工程指南：10 条实战技巧和 3 种构建模式](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/cover.png)
...
![智能体三大核心能力：技能、Shell、压缩的协作关系](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/01-infographic-mental-model.png)
...
![技能描述应回答的三个核心问题](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/02-infographic-decision-boundary.png)
...
![Glean 案例：负面示例如何恢复路由准确率](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/03-infographic-negative-examples.png)
...
![系统提示词塞模板 vs 技能内模板的 token 消耗对比](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/04-infographic-templates-in-skills.png)
...
![长期运行设计三支柱：容器复用、线程延续、默认压缩](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/05-infographic-long-running-design.png)
...
![灵活 vs 确定性：何时让模型自主选择，何时明确指定](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/06-infographic-determinism-vs-flexibility.png)
...
![安全默认配置：Skills 和 Shell 允许，网络仅限最小白名单](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/07-infographic-skills-network-risk.png)
...
![工具写入→模型推理→开发者取回的三段式工作流](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/08-infographic-mnt-data-boundary.png)
...
![双层白名单：组织级（大范围）嵌套请求级（小范围子集）](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/09-infographic-two-layer-allowlist.png)
...
![domain_secrets 凭据注入流程：模型看占位符，边车注入真实值](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/10-infographic-domain-secrets.png)
...
![本地↔云端开发循环：技能作为不变的桥梁](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/11-infographic-local-cloud-api.png)
...
![模式 A：安装→获取→写产出物的三步工作流](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/12-infographic-pattern-a.png)
...
2. 把技能**挂载到 Shell 环境**
3. 让智能体按照技能**确定性地生成产出物**

对电子表格分析编辑、数据清洗加摘要生成、重复性业务的标准化报告生成特别有效。

![模式 B：技能解决提示词漂移，实现可重复工作流](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/13-infographic-pattern-b.png)
...
![Glean 案例：73%→85% 准确率提升，技能作为活的 SOP](https://s.baoyu.io/imgs/2026-02-12/skills-shell-tips/14-infographic-pattern-c.png)
