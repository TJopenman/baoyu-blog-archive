...
date: 2026-01-24
original_url: https://baoyu.io/blog/2026/01/24/skill-vs-prompt
---
...
![Skill 不就是长一点的提示词吗？](https://s.baoyu.io/imgs/2026-01-24/skill-vs-prompt/cover.png)

![](https://s.baoyu.io/imgs/2026-01-24/skill-vs-prompt/imgs/cover.png)
...
![ChatBot vs Agent：一个只能说，一个能动手](https://s.baoyu.io/imgs/2026-01-24/skill-vs-prompt/01-comparison-chatbot-vs-agent.png)
...
![Agent 配图工作流：6 步自动化完成](https://s.baoyu.io/imgs/2026-01-24/skill-vs-prompt/02-flowchart-agent-workflow.png)
...
![Skill 的三层架构：元数据、指令、资源代码](https://s.baoyu.io/imgs/2026-01-24/skill-vs-prompt/03-framework-skill-layers.png)
...
![同一个提示词，发给 ChatBot 和 Agent 的结果天差地别](https://s.baoyu.io/imgs/2026-01-24/skill-vs-prompt/04-comparison-prompt-destination.png)
...
![Skill 的四大价值：可复用、可组合、可迭代、可渐进加载](https://s.baoyu.io/imgs/2026-01-24/skill-vs-prompt/05-comparison-skill-advantages.png)
