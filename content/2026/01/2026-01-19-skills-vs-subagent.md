...
一句话解释 SubAgent 和 Skills 的区别：

AI Agent 就像操作系统，Skills 就像应用程序，SubAgent 也是操作系统，不过预装了应用，并且像虚拟机一样运行，独立上下文。
...
：三套图的生成过程全堆在主 Agent 的“脑子”里，几十张图的提示词、中间结果、错误重试……全占着位置
...
Skills 是应用程序，装在主系统里按需调用；SubAgent 是虚拟机，独立运行完再把结果交回来。
