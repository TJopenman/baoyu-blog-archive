---
title: "\u591a\u7a3f\u5408\u5e76\uff1a\u4ece\u624b\u52a8\u6bd4\u7a3f\u5230\u4e00\u952e Skill"
date: 2026-03-05
original_url: https://baoyu.io/blog/2026-03-04/ai-merge-drafts-into-skills
---
...
![多稿合并：从手动比稿到一键 Skill](https://s.baoyu.io/imgs/2026-03-04/ai-merge-drafts-into-skills/cover.png)
...
![三个版本各有亮点](https://s.baoyu.io/imgs/2026-03-04/ai-merge-drafts-into-skills/01-infographic-three-versions.png)
...
![AI 多稿合并四步流程](https://s.baoyu.io/imgs/2026-03-04/ai-merge-drafts-into-skills/02-infographic-ai-merge-flow.png)
...
> 1. 阅读所有提供的稿子
> 2. 选一份最好的稿子作为基础
> 3. 将其他稿子中有价值的内容或者基础稿子缺失的重要部分加入到基础稿
> 4. 对完成后的稿子润色
...
![两种创建 Skill 的方式对比](https://s.baoyu.io/imgs/2026-03-04/ai-merge-drafts-into-skills/03-infographic-two-methods.png)

如果你对流程还不太确定，或者这个任务你之前没做过，用**方式一**。先手动做一遍，摸清楚哪些步骤重要、哪些细节容易出错，再固化。

如果你已经反复做过很多次，流程很清晰了，用**方式二**。直接描述需求，省掉手动执行的时间。
